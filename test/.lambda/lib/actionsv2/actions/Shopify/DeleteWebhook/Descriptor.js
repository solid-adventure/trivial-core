...
class DeleteWebhookDescriptor extends ShopifyOAuth2DescriptorBase {
  get fullDescriptionHTML() {
    return `This action deletes webhooks for Shopify stores.
    <h2>Overview</h2>
...
module.exports = DeleteWebhookDescriptor 