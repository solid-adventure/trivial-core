...
const DeleteWebhookAction = require('../../../../../../lib/actionsv2/actions/Shopify/DeleteWebhook/Action')

describe('Shopify/DeleteWebhookAction', () => {
  ...
  describe('.perform', () => {
    ...
    let action = new DeleteWebhookAction(input)
    ...
    it('performs a delete', () => {
        expect(action.fetch).to.have.been.calledOnceWith(match.string, match({method: 'DELETE'}));
    })
