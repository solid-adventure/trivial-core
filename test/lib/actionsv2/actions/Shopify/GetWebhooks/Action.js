...
const GetWebhooksAction = require('../../../../../../lib/actionsv2/actions/Shopify/GetWebhooks/Action')

describe('Shopify/GetWebhooksAction', () => {
  ...
  describe('.perform', () => {
    ...
    let action = new GetWebhooksAction(input)
