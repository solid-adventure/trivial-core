...
const TRIVIAL_CREDENTIAL_SERVICE = 'TRIVIAL-API'
...
class CredentialManager {
  ...
  static async credentials() {
    ...
    if (process.env.CREDENTIALS_SERVICE === TRIVIAL_CREDENTIAL_SERVICE && process.env.TRIVIAL_API_KEY) {
      const res =  await fetch(
        ...
        headers: {
          ...
          'authorization': `Bearer ${process.env.TRIVIAL_API_KEY}`
        },
      })
