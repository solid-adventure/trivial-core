...
class AppTemplate {
  constructor(name, version, initial_manifest, template_dir) {
    ...
    this.template_dir = template_dir || __dirname
  }
  ...
  get path() {
    return path.resolve(this.template_dir, path.join('..', 'templates', this.token))
  }
