const AVAILABLE_ACTIONS = Object.freeze({
  ...
  Arka: {
    Generic: require('../actionsv2/actions/Arka/Generic/Descriptor'),
  },
  Collect: require('../actionsv2/actions/Collect/Descriptor'),
  Custom: require('../actionsv2/actions/Custom/Descriptor'),
  Discord: {
    PostMessage: require('../actionsv2/actions/Discord/PostMessage/Descriptor'),
  },
  ...
  Shopify: {
    CreateFulfillment: require('../actionsv2/actions/Shopify/CreateFulfillment/Descriptor'),
    CreateWebhook: require('../actionsv2/actions/Shopify/CreateWebhook/Descriptor'),
    DeleteWebhook: require('../actionsv2/actions/Shopify/DeleteWebhook/Descriptor'),
    GetWebhook: require('../actionsv2/actions/Shopify/GetWebhook/Descriptor'),
    GetWebhooks: require('../actionsv2/actions/Shopify/GetWebhooks/Descriptor'),
    UpdateWebhook: require('../actionsv2/actions/Shopify/UpdateWebhook/Descriptor'),
  },
  Slack: {
  ...
  Whiplash: {
    CalculateFee: require('../actionsv2/actions/Whiplash/CalculateFee/Descriptor'),
    Generic: require('../actionsv2/actions/Whiplash/Generic/Descriptor'),
    GetOrders: require('../actionsv2/actions/Whiplash/GetOrders/Descriptor'),
    GetOrdersCount: require('../actionsv2/actions/Whiplash/GetOrdersCount/Descriptor'),
  },
})
